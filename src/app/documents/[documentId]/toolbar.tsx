      ...
      <DropdownMenuContent className="p-1 flex flex-col gap-y-3">
        {lineHeights.map(({ label, value }) => (
          <button
            ...
            className={cn(
              "flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bgneutral-200/80 ",
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="h-7 w-7 shrink-0 flex items-center justify-center rounded-sm bg-transparent cursor-text"
        >
          {" "}
          {currentFontSize}
        </button>
...
const ToolbarButton = ({
  ...
  return (
    <button onClick={onClick}>
      ...
      <Icon
        className={cn(
          "size-4 min-w-7 flex  items-center justify-center rounded-sm hover:bg-neutral-200/80",
          isActive && "bg-neutral-200/80"
        )}
      />
    </button>
